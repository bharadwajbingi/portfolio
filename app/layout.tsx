...
export const metadata: Metadata = {
  ...
  authors: [{ name: profile.personal.name, url: profile.social.find(s => s.platform === 'GitHub')?.url }],
  ...
  twitter: {
    ...
    description: profile.personal.tagline,
    images: ['/og-image.jpg'],
    creator: profile.social.find(s => s.platform === 'Twitter')?.url?.replace('https://twitter.com/', '@') || '@bharadwajbingi',
  },
  robots: {
    index: true,
    follow: true,
